...
// }
  ...
  <div className="side_menu" id="side_bar">
    ...
    <div className="side_menu_list">
      ...
      <div className="visible" onclick="intern_ship()">
        <div className="side_menu_svg_cont">
          <svg
            className="side_menu_svg"
            focusable="false"
      ...
      <div className="visible" onclick="disappear(1)">
        <div className="side_menu_svg_cont">
          <svg
            className="side_menu_svg"
            focusable="false"
      ...
      <div className="visible when_login" onclick="transcations()">
        <div className="side_menu_svg_cont">
          <svg
            className="side_menu_svg"
            focusable="false"
      ...
      <div className="visible after_login" onclick="disappear(2)">
        <div className="side_menu_svg_cont">
          <svg
            className="side_menu_svg"
            focusable="false"
      ...
      <div id="div_2_1" className="hidden visible" onclick="register()">
        <div className="side_menu_svg_cont"></div>
        <div className="side_menu_content">
          <p>Company</p>
        </div>
      </div>
      <div id="div_2_2" className="hidden visible" onclick="register()">
        <div className="side_menu_svg_cont"></div>
        <div className="side_menu_content">
          <p>Student</p>
        </div>
      </div>
      <div className="visible after_login" onclick="disappear(3)">
        <div className="side_menu_svg_cont">
          <svg
            className="side_menu_svg"
            focusable="false"
      ...
      <div id="div_3_2" className="hidden visible" onclick="logIn()">
        <div className="side_menu_svg_cont"></div>
        <div className="side_menu_content">
          <p>Student</p>
        </div>
