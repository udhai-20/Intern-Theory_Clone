...
const Step2 = () => {
  return (
    <div className="register_step_2" id="register_step_2">
      <div className="step_2_main">
        ...
        <div className="step_2_form">
          <form id="step_2_form">
            ...
            <div>
              <label for="degree" style={{ color: "red", fontWeight: "bold" }}>
                Degree *
              </label>
              <input
                type="text"
            ...
            <div>
              <label for="year" style={{ color: "red", fontWeight: "bold" }}>
                Select Year *
              </label>
              <input
                type="text"
